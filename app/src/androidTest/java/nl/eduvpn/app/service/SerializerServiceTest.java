...
public class SerializerServiceTest {
    ...
    public void testInstanceSerialization() throws SerializerService.UnknownFormatException {
        Instance instance = new Instance("baseUri", "displayName", "logoUri", AuthorizationType.Companion.getDISTRIBUTED(), true);
    ...
    public void testInstanceListSerialization() throws SerializerService.UnknownFormatException {
        Instance instance1 = new Instance("baseUri", "displayName", "logoUri", AuthorizationType.Companion.getDISTRIBUTED(), true);
        Instance instance2 = new Instance("baseUri2", "displayName2", "logoUri2", AuthorizationType.Companion.getDISTRIBUTED(), true);
    ...
    public void testSavedTokenListSerialization() throws SerializerService.UnknownFormatException {
        Instance instance1 = new Instance("baseUri1", "displayName1", null, AuthorizationType.Companion.getDISTRIBUTED(), true);
        Instance instance2 = new Instance("baseUri2", "displayName2", null, AuthorizationType.Companion.getLOCAL(), true);
    ...
    public void testSavedProfileListSerialization() throws SerializerService.UnknownFormatException {
        Instance instance1 = new Instance("baseUri1", "displayName1", "logoUri1", AuthorizationType.Companion.getDISTRIBUTED(), true);
        Instance instance2 = new Instance("baseUri2", "displayName2", "logoUri2", AuthorizationType.Companion.getLOCAL(), true);
    ...
    public void testSavedKeyPairSerialization() throws SerializerService.UnknownFormatException {
        KeyPair keyPair = new KeyPair(false, "cert1", "pk1");
        Instance instance = new Instance("http://example.com/", "example.com", null, AuthorizationType.Companion.getDISTRIBUTED(), false);
        ...
        keyPair = new KeyPair(true, "example certificate", "example private key");
        instance = new Instance("http://something.else/", "something.else", "http://www.example.com/logo", AuthorizationType.Companion.getLOCAL(), true);
    ...
    public void testSavedKeyPairListSerialization() throws SerializerService.UnknownFormatException {
        ...
        Instance instance2 = new Instance("http://something.else/", "something.else", "http://www.example.com/logo", AuthorizationType.Companion.getLOCAL(), true);
